...
describe OpenSearch::Model::Adapter::Default do

  before(:all) do
    class DummyClassForDefaultAdapter; end
    DummyClassForDefaultAdapter.__send__ :include, OpenSearch::Model::Adapter::Default::Records
    DummyClassForDefaultAdapter.__send__ :include, OpenSearch::Model::Adapter::Default::Importing
  end

  after(:all) do
    OpenSearch::Model::Adapter::Adapter.adapters.delete(DummyClassForDefaultAdapter)
  ...
  it 'should have the default Callback implementation' do
    expect(OpenSearch::Model::Adapter::Default::Callbacks).to be_a(Module)
  end
