...
#     $ rails new searchapp --skip --skip-bundle --template https://raw.githubusercontent.com/elastic/opensearch-rails/main/opensearch-rails/lib/rails/templates/05-settings-files.rb
