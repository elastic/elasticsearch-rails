...
# =====================================================================================================
# Template for generating a no-frills Rails application with support for OpenSearch full-text search
# =====================================================================================================
#
# This file creates a basic, fully working Rails application with support for OpenSearch full-text
# search via the `opensearch-rails` gem; https://github.com/compliance-innovations/opensearch-rails.
#
# Requirements:
# -------------
#
...
begin
  ...
  say_status "", "The application requires an OpenSearch cluster running, " +
...
unless cluster_info['version']
  say_status "ERROR", "Cannot determine OpenSearch version from <#{$OPENSEARCH_URL}>", :red
  say_status "", JSON.dump(cluster_info), :red
  exit(1)
end

if cluster_info['version']['number'] < required_opensearch_version
  say_status "ERROR",
...
# Ruby on Rails and OpenSearch: Example application

This application is an example of integrating the {OpenSearch}[https://opensearch.org/]
...
https://github.com/compliance-innovations/opensearch-rails/tree/main/opensearch-rails/lib/rails/templates.
...
# ----- Add OpenSearch integration into the model ----------------------------------------------
...
git commit: "-a -m 'Added OpenSearch support into the Article model'"

# ----- Add OpenSearch integration into the interface ------------------------------------------
