...
class Elasticsearch::Model::ResponseTest < Test::Unit::TestCase
  context "Response" do
    ...
    RESPONSE = { 'took' => '5', 'timed_out' => false, '_shards' => {'one' => 'OK'}, 'hits' => { 'hits' => [] },
                 'aggregations' => {'total_fooness' => {'value' => 10}}}
    ...
    should "access the aggregations" do
      ...
      assert_kind_of Hashie::Mash, response.aggregations.total_fooness
      assert_equal 10, response.aggregations.total_fooness.value
    end
  end
end
